...
export default {
  cn: {
    ...
    overview: {
      ...
      desList: ['我叫貟莉莉，华夏天达资深前端工程师', '曾任华夏天达团队前端负责人', 'moli@insfair.cn']
    },
    skill: {
      outCircleList: [
        {
      ...
      desList: [
        '三年前端开发经验，两年管理经验',
        '实际主导开发过多平台项目（APP，PC，H5，小程序等），制定并规范团队协作模式',
      ...
      expList: [
        {
          ...
          contentList: ['负责华夏优码项目的开发工作', '参与制定团队协作规范', '参与一些优码客户小程序、B端开发', '参与开源社区贡献']
        },
        {
          title: '聚美优品',
          time: '2020年4月~2022年1月',
          post: '资深前端工程师/前端负责人',
          img: {
